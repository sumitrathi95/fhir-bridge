...
#|  ressourceType  |     ID     |           meta         |  status  |                             Identifier                            |                      category                             |                                        code                                      |         subject                        |      DateTime  |                      valueQuantity                     |  dataabsentreason  |  ArryNumber  |  R.-Code  |  diagnostics  |
#|                 |            |  available  | profile  |          |  avalable  |  coding.system  |  coding.code  |  system  |  value  |  available  |  codingavailable  |  system  |     code     |  available  |  coding available  |  0.system  |  0.code  |  1.system  |  1.code  |  available  |          reference       |                |  available  |  value  |  unit  |  system      |  code  |                    |              |           |               |
    Observation    	 heart-rate    true         valid		final		true          valid             test         valid      abcd       true             true            valid      vital-signs       true			true			  valid		  8867-4		valid         abcd    true    		         valid      		2020-02-25		true		 ${80.7}	test	    valid	   /min				201    	${EMPTY}
    Observation    	 heart-rate    false         valid		final		true          valid             test         valid      abcd       true             true            valid      vital-signs       true			true			  valid		  8867-4		valid         abcd    true    		         valid      		2020-02-25		true		 ${80.7}	test	    valid	   /min				422    	${EMPTY}
