...
public enum NamensartDefiningcode implements EnumValueSet {
  ...
  FRUHERER_NAME("Früherer Name", "Von der Person früher benutzter Name.", "local", "at0008"),

  MADCHENNAME("Mädchenname", "Der Name der bis zur Heirat benutzt wurde.", "local", "at0012"),
