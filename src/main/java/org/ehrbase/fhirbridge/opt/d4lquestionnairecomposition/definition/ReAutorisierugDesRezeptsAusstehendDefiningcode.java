...
public enum ReAutorisierugDesRezeptsAusstehendDefiningcode implements EnumValueSet {
  RE_AUTORISIERUG_DES_REZEPTS_AUSSTEHEND("Re-Autorisierug des Rezepts ausstehend", "Die Ausstellung des Rezeptes wartet auf die erneute Re-Autorisierung durch einen Arzt.", "local", "at0011");
