...
public class ReiseaktivitatComposition {
  ...
  @Path("/content[openEHR-EHR-OBSERVATION.travel_event.v0 and name/value='Reiseaktivität']")
  private ReiseaktivitatObservation reiseaktivitat;
  ...
  public void setReiseaktivitat(ReiseaktivitatObservation reiseaktivitat) {
     this.reiseaktivitat = reiseaktivitat;
  }

  public ReiseaktivitatObservation getReiseaktivitat() {
     return this.reiseaktivitat ;
  }
