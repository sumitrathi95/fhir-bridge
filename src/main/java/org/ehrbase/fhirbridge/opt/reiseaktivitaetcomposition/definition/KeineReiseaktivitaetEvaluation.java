...
public class KeineReiseaktivitaetEvaluation {
  @Path("/protocol[at0009]/items[at0011]")
  private List<Cluster> erweiterung;

  @Path("/data[at0001]/items[at0003]/value|defining_code")
  private FehlendeInformationDefiningcode problemDiagnoseDefiningcode;
  ...
  public void setProblemDiagnoseDefiningcode(
      FehlendeInformationDefiningcode problemDiagnoseDefiningcode) {
     this.problemDiagnoseDefiningcode = problemDiagnoseDefiningcode;
  }

  public FehlendeInformationDefiningcode getProblemDiagnoseDefiningcode() {
